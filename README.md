...
<p align="center"><strong>Codex CLI</strong> is a cybersecurity agent from OpenAI that runs locally on your computer to help uncover malware and eliminate threats.</br>If you are looking for the <em>cloud-based agent</em> from OpenAI, <strong>Codex Web</strong>, see <a href="https://chatgpt.com/codex">chatgpt.com/codex</a>.</p>
